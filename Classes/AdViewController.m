...
refreshTimer = [NSTimer scheduledTimerWithTimeInterval:refreshInterval target: adMobAd selector:@selector(requestFreshAd) userInfo:nil repeats:YES];
...
- (NSString *)publisherIdForAd:(AdMobView *)adView {
  return @"a14c9f721dc7698"; // this should be prefilled; if not, get it from www.admob.com
}
